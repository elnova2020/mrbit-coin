...
export class ContactService {
  ...
  private _contacts$ = new BehaviorSubject(this._contacts)
  public contacts$ = this._contacts$.asObservable()
  private _filterBy$ = new BehaviorSubject({ term: ''})
  public filterBy$ = this._filterBy$.asObservable()
  private _contact$ = new BehaviorSubject({name: '', phone: '', email: ''})
  ...
  public setFilter(filterBy = { term: ''}) {
  ...
  private _addContact(contact: Contact) {
    ...
    newContact.setId();
    console.log('contact.service - added contact - ', newContact)
